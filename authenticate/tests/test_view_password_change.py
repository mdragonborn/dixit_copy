...
class PasswordChangeTests(TestCase):
    def setUp(self):
        username = 'john'
        password = 'secret123'
        user = Player.objects.create_user(username=username, email='john@doe.com', password=password)
...
class PasswordChangeTestCase(TestCase):
    ...
    def setUp(self, data={}):
        self.user = Player.objects.create_user(username='john', email='john@doe.com', password='old_password')
